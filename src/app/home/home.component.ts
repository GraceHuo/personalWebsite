...
export class HomeComponent implements OnInit {
  ...
  position: String = 'TES IT Improvement Manager';
  descriptions = [];
  ...
  characteristics = [
    {
      name: 'Problem Solver',
      details: 'My work is full of challenges, ' +
    ...
    {
      name: 'Quick Learner',
      details: 'Tools and techniques used for software development change constantly. ' +
